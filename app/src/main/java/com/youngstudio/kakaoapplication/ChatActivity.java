...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(ChatG.nickName);
    ...
    public void clickSend(View view) {
        ...
        String nickName= ChatG.nickName;
        String message= et.getText().toString();
        String profileUrl= ChatG.profileUrl;
        ...
        ChatItem messageItem= new ChatItem(nickName, message, time, profileUrl);
