...
public class ChatMainActivity extends AppCompatActivity {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ChatG.profileUrl= uri.toString();
                        Toast.makeText(ChatMainActivity.this, "프로필저장 완료", Toast.LENGTH_SHORT).show();
                        ...
                        profileRef.child(ChatG.nickName).setValue(ChatG.profileUrl);

                        //2. 내 phone에 nickName, profileUrl을 저장
                        SharedPreferences preferences= getSharedPreferences("account", MODE_PRIVATE);
                        SharedPreferences.Editor editor= preferences.edit();

                        editor.putString("nickName", ChatG.nickName);
                        editor.putString("profileUrl", ChatG.profileUrl);
    ...
    void loadData(){
        SharedPreferences preferences= getSharedPreferences("account",MODE_PRIVATE);
        ChatG.nickName= preferences.getString("nickName",null);
        ChatG.profileUrl= preferences.getString("profileUrl",null);
    }
